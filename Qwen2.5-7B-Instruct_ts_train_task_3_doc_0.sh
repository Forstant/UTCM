user_name=lsy_train_ts_task_3_doc_0
purpose='ts_train_task_3_doc_0的数据的sft'
export CUDA_VISIBLE_DEVICES=0
model_name=Qwen2.5-7B-Instruct
method=sft
model_config_name=Qwen2.5-7B-Instruct_ts_train_task_3_doc_0.yaml
model_config="configs/sft/${model_config_name}"
# 预测配置
predict_config_name_oriset=Qwen2.5-7B-Instruct_lora_predict_ts_train_task_3_doc_0_sft_test.yaml
predict_config_name_cotset=Qwen2.5-7B-Instruct_lora_predict_ts_train_task_3_doc_0_test_cot.yaml
