...
task=1
doc=2
user_name="pzb_train_ts_task_${task}_doc_${doc}"
purpose="ts_train_task_${task}_doc_${doc}的数据的sft"
export CUDA_VISIBLE_DEVICES=0
model_name=Qwen2.5-7B-Instruct
method=sft
model_config_name="Qwen2.5-7B-Instruct_ts_train_task_${task}_doc_${doc}.yaml"
model_config="configs/sft/${model_config_name}"
# 预测配置
predict_config_name_oriset="Qwen2.5-7B-Instruct_lora_predict_ts_train_task_${task}_doc_${doc}_sft_test.yaml"
predict_config_name_cotset="Qwen2.5-7B-Instruct_lora_predict_ts_train_task_${task}_doc_${doc}_test_cot.yaml"
...
lr_list=(5.0e-5)
warmup_ratio_list=(0.25 0.2 0.15 0.1 0.05)
