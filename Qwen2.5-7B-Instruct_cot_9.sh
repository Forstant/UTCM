user_name=lyx_cot9
# user_name=lsy_train1
# user_name=lsy_train2
purpose='cot的数据的sft'
export CUDA_VISIBLE_DEVICES=0
model_name=Qwen2.5-7B-Instruct
method=sft
model_config_name=Qwen2.5-7B-Instruct_cot_9.yaml
# model_config_name=${model_name}_sft1.yaml
# model_config_name=${model_name}_sft2.yaml
model_config="configs/sft/${model_config_name}"
predict_config_name_oriset=Qwen2.5-7B-Instruct_lora_predict_cot_oriset.yaml
predict_config_name_cotset=Qwen2.5-7B-Instruct_lora_predict_cot_cotset.yaml
